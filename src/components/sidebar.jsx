...
function SideBar() {
  return (
    <div className="sideBar bg-slate-900 w-64 h-screen flex flex-col px-6 py-3 gap-5  mb-6">
      <div className="header-user  flex flex-none gap-5 items-center-safe rounded-full">
